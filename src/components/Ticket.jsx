              ...
              <div className='flex flex-col lg:gap-10 gap-2 relative bottom-[132px] px-5 lg:bottom-56 lg:px-20' >
                ...
                <div>
                  <div className='flex items-center gap-2 lg:gap-4'>
                    <img className='lg:w-16 w-10 rounded-lg' src={avatar} alt="" />

                    <div className=''>
                      <h1 className='text-xl lg:text-2xl font-bold'>Jonatan Kristof</h1>
                      <div className='flex font-medium text-gray-300 gap-1 lg:gap-2 lg:text-base text-sm'><img className='w-3 lg:w-5' src={githubIcon} alt="" /> @JonatanKristof0101</div>
                    </div>
                  </div>
                </div>
